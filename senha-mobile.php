    ...
    try {
        ...
        if ($resultado) {
            ...
            if (filter_var($identificador_puro, FILTER_VALIDATE_EMAIL)) {
                ...
                if(strlen($numeros_identificador) >= 4) {
                    $telefone_final = substr($numeros_identificador, -4);
                }
            }
        } else {
