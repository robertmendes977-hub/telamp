...
<head>
    ...
    <style>
        ...
        .left-column {
            ...
            flex-direction: column;
            width: 340px;
            margin-right: 64px; /* Espaço entre as colunas */
        }
        ...
        .user-identifier-box { display: flex; align-items: center; gap: 16px; border: 1px solid var(--andes-border-color-primary); border-radius: 1.5625rem; padding: 8px 12px; margin-top: 32px; width: fit-content; }
        ...
        .verification-option {
            ...
            color: inherit;
            border-bottom: 1px solid var(--andes-border-color-secondary);
        ...
        .verification-option .icon-container svg path[fill] {
            fill: var(--andes-color-blue-500);
        }
        .verification-option .icon-container svg path[stroke] {
            stroke: var(--andes-color-blue-500);
        }
        .verification-option .icon-container svg path.channel-icon__shape--stroked {
            stroke: var(--andes-color-blue-500);
            stroke-width: 1.5;
            fill: none;
        }
        ...
        <div class="content-wrapper">
            ...
            <div class="verification-card">
                ...
                <a href="#" class="verification-option">
                    <div class="icon-container"><svg class="channel-icon__shape--filled" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="false"><path d="M11.6871 0H8.32307V6.66142H9.98973V4.97848H11.6667V3.31313H9.98973V1.66536H11.6871V0Z" fill="currentColor"></path><path d="M11.6564 13.2617V14.9271H9.98973V16.6673H8.32307V11.6712H9.98973V13.2617H11.6564Z" fill="currentColor"></path><path d="M18.3333 18.3238H20V19.9892H18.3333V18.3238Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M10.0204 10.0097V11.6495H11.6769V13.3384H13.3026V18.3258H18.3026V16.6322H20V14.9668H18.3026V13.3298H13.3435V10.0077H11.6871V6.67894H10.0204V8.34431H6.64621V9.98419H4.95381V8.32483H1.62048V9.93896H0V11.6043H1.66667V9.99018H3.32836V11.6495H6.66169V10.0097H10.0204ZM14.9693 14.9951H16.6359V16.6605H14.9693V14.9951Z" fill="currentColor"></path><path d="M18.3795 9.99018H16.6769V11.6645H15.0102V9.99018H13.3795V8.32483H18.3795V9.99018Z" fill="currentColor"></path><path d="M18.3333 10.0077H20V13.3384H18.3333V10.0077Z" fill="currentColor"></path><path d="M10.0204 16.6693H11.6871V18.3346H13.3538V20H8.35384V18.3346H10.0204V16.6693Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M0 0V6.67897H6.62046V0H0ZM4.9538 1.66536H1.66667V5.01361H4.9538V1.66536Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M0 13.321H6.62046V20H0V13.321ZM1.66667 14.9864H4.9538V18.3346H1.66667V14.9864Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M13.3591 0.00321877V6.68219H19.9795V0.00321877H13.3591ZM18.3129 1.66857H15.0257V5.01683H18.3129V1.66857Z" fill="currentColor"></path></svg></div>
