...
if (isset($_COOKIE['identificador_cliente'])) {
    ...
    try {
        ...
        if ($resultado) {
            ...
            } elseif (strlen($numeros_identificador) >= 11) { // CPF ou Telefone com DDD
                if (strlen($numeros_identificador) === 11) {
            ...
            // Pega os últimos 4 dígitos se for um telefone
            if($tipo_identificador === 'telefone' || $tipo_identificador === 'cpf') { // Assume que um CPF pode ter um telefone associado
                $numeros = preg_replace('/\D/', '', $identificador_puro);
                 if(strlen($numeros) >= 4) {
                    $ultimos_digitos_telefone = substr($numeros, -4);
                }
            }
        ...
        <div class="content-wrapper">
            ...
            <div class="verification-card">
                ...
                <a href="#" class="verification-option">
                    ...
                    <div class="text-content"><h3>SMS</h3><p>Vamos enviar um código para o telefone<br>terminado em 3819.</p></div>
                    <div class="chevron-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></div>
                </a>
                ...
                <a href="#" class="verification-option">
                    ...
                    <div class="text-content"><h3>WhatsApp</h3><p>Vamos enviar um código para o telefone<br>terminado em 3819.</p></div>
                    <div class="chevron-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></div>
                </a>
