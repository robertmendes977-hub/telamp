...
<head>
    ...
    <style>
        ...
        .content-wrapper { max-width: 960px; margin: 0 auto; display: flex; justify-content: space-between; align-items: flex-start; }
        .left-column { display: flex; flex-direction: column; width: 340px; margin-right: 64px; }
        ...
        .verification-option {
            ...
            color: inherit;
            /* ALTERAÇÃO: Removida a borda de baixo de cada opção */
        ...
        .verification-option .icon-container svg path[fill] { fill: var(--andes-color-blue-500); }
        .verification-option .icon-container svg path[stroke] { stroke: var(--andes-color-blue-500); }
        ...
        /* NOVO: Estilo para a linha separadora final */
        .final-separator {
            height: 1px;
            background-color: var(--andes-border-color-secondary);
            margin: 8px 24px; /* Margem vertical e horizontal para não ir de ponta a ponta */
        }

        /* ALTERAÇÃO: Link final alinhado à esquerda */
        .cant-login-link {
            display: block;
            text-align: left; 
            ...
            font-size: 15px;
            font-weight: 500;
            padding: 16px 24px 24px 24px; /* Ajuste no padding */
        }
