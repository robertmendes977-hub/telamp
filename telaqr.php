...
<head>
    ...
    <style>
        ...
        .main-header { background-color: var(--andes-color-yellow-500); padding: 0 700px; box-shadow: 0 1px 2px 0 rgba(0,0,0,.1); height: 60px; display: flex; align-items: center; justify-content: flex-start; }
        ...
        .session-start-label { font-size: 12px; font-weight: 400; color: var(--andes-text-color-secondary); text-transform: uppercase; margin-bottom: 8px; }
        .main-title { font-size: 28px; font-weight: 600; color: var(--andes-text-color-primary); line-height: 1.25; margin: 0; }
        .description-text { font-size: 16px; font-weight: 400; color: var(--andes-text-color-secondary); margin-top: 16px; line-height: 1.5; }
