...
<head>
    ...
    <style>
        ...
        .main-header { background-color: var(--andes-color-yellow-500); padding: 0 750px; box-shadow: 0 1px 2px 0 rgba(0,0,0,.1); height: 60px; display: flex; align-items: center; justify-content: flex-start; }
