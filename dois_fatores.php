...
<head>
    ...
    <style>
        :root {
            ...
            --cor-fundo: #fff; /* Fundo agora é branco */
            --cor-card: #fff;
        }
        body {
            margin: 0;
        ...
        main {
            /* Removemos o flexbox para posicionar com margem */
            padding: 24px;
        }
        .verification-card {
            ...
            padding: 40px;
            text-align: center;
            max-width: 520px; /* Card maior */
            width: 100%;
            box-sizing: border-box;
            margin: 80px auto 0 auto; /* Margem no topo para empurrar para baixo */
        }
        .card-icon {
            margin-bottom: 24px;
            /* O SVG controla seu próprio tamanho */
        }
        .card-title {
            font-size: 24px;
