...
// 2. Lógica "Inteligente" que agora funciona corretamente
if ($lead_id_from_admin) {
    ...
    // A lógica de bloqueio foi REMOVIDA. O ping da nova página irá
    // naturalmente sobrescrever o comando de redirecionamento.
    $sql = "UPDATE captura_login SET status = ? WHERE id = (
